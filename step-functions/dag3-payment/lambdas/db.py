...
`<BAKEOFF_NS>_dag3`, the repo-wide convention from shared-services/init-db.sql.
Neon is shared with the Google Workflows implementation, so the namespace is what
keeps the two apart: `stepfunctions_dag3` vs `google_workflows_dag3`.

NOT self-creating, unlike DAG 1: this schema holds the seeded accounts this DAG debits.
